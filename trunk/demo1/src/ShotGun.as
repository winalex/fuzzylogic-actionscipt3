package
{
	...
	public class ShotGun extends Weapon
	{
		...
		public function ShotGun(ammo:uint):void
		{
			super(ammo);
		}
		...
		override protected function getFuzzificator():Fuzzificator
		{
			...
			func = factory.create(FuzzyMembershipFunction.RIGHT_SHOULDER, "Far",150,170,200); //  [150 300 400 400]
			manifold.addMember(func);
			...
			fuz.addRule(rule);
			rule = new FuzzyRule("IF Distance_to_Target IS Medium AND Ammo_Status IS Loads THEN Desirability IS Desirable ");
			fuz.addRule(rule);
		...
		{
			var missile:DisplayObject = new Slug();
